...
The distribution shows that that most users tend to purchase a product between the 5th game and 25th game. The average number of games played prior to first purchase is approx. 14. There is a spike in number of users purchasing a product after 1st, 2nd and 4th game. This could be potentially due to display of shop for test groups at these junctures. Purchase of  a product peaks post the 8th game. This activity can be quantified by the emperical Cumulative Distribution Function (eCDF).  
...
In general it can be seen that when the shop is first displayed there is high buying activity.
...
A group wise probability analysis of purchases reveals strong purchasing tendencies in the very early stages of the game. This study makes a strong case for display of shop early.
